	...
	<main class="container">
		<header class="row pt-5 pb-2">
			...
			<div class="col-3 text-right">
				<img src="../images/trophy-svgrepo-com.svg"
					style="width: 30px; height: 30px;" class="mr-4 mt-2" alt="">
			</div>
		</header>
		<nav class="row">
			<nav class="col navbar navbar-expand-sm navbar-light bg-light">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavId">
					<ul class="navbar-nav mr-auto mt-2 mt-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="#"><i
								class="fa fa-comments" aria-hidden="true"></i> My Favorite Us</a></li>
		...
		<footer class="row">
			<div class="col text-center border-top">
				<strong>Khanh Nguyen Duy &copy;2023. All rights reserved.</strong>
			</div>
